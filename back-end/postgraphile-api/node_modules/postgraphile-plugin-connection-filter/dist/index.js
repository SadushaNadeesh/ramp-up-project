...
const PostGraphileConnectionFilterPlugin = (builder, configOptions) => {
    ...
    ConnectionArgFilterPlugin_1.default(builder, options);
    PgConnectionArgFilterPlugin_1.default(builder, options);
    PgConnectionArgFilterColumnsPlugin_1.default(builder, options);
    PgConnectionArgFilterComputedColumnsPlugin_1.default(builder, options);
    PgConnectionArgFilterCompositeTypeColumnsPlugin_1.default(builder, options);
    PgConnectionArgFilterRecordFunctionsPlugin_1.default(builder, options);
    if (connectionFilterRelations) {
        PgConnectionArgFilterBackwardRelationsPlugin_1.default(builder, options);
        PgConnectionArgFilterForwardRelationsPlugin_1.default(builder, options);
    }
    if (connectionFilterLogicalOperators) {
        PgConnectionArgFilterLogicalOperatorsPlugin_1.default(builder, options);
    }
    PgConnectionArgFilterOperatorsPlugin_1.default(builder, options);
};
